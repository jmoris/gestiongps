        ...
        <div class="card-body">
                ...
                <form method="POST" action="/dispositivos/{{$dispositivo->uniqueId}}">     
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="telefono" placeholder="Ej:" value="{{$dispositivo->phone}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="modelo" placeholder="Ej:" value="{{$dispositivo->model}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="contacto" placeholder="Ej:" value="{{$dispositivo->contact}}" >
                        </div>
                    </div>
