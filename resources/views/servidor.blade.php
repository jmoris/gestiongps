...
<div class="card-body">
    ...
    @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="gridCheck1" name="check_registro" @if($servidor->registration)checked @endif>
                    <label class="form-check-label" for="gridCheck1">
                        Sí
                    </label>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="latitud" placeholder="Ej: -33.4726900" value="{{$servidor->latitude}}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="longitud" placeholder="Ej: -70.6472400" value="{{$servidor->longitude}}">
            </div>
        </div>
