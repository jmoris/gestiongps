                        ...
                        <form>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" autocomplete="off" class="form-control" id="inputEmail" placeholder="Email">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword">Constraseña</label>
                                        <input type="password" autocomplete="off" class="form-control" id="inputPassword" placeholder="Contraseña">
                                    </div>
                                </div>
                                <div class="form-row">
                                        <div class="form-group col-md-5">
                                                <p>Fecha de expiración: <input type="text" id = "datepicker"></p>
                                          </div>
                                </div>
                                <div class="form-group">
